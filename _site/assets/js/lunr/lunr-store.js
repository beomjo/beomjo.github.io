var store = [{
        ...
        "title": "BOJ 4179. 불!",
        "excerpt":"BOJ 4179. 불! 풀이 #, ., J, F로 이루어진 2차원 배열이 주어지고, 주어진 값들은 각각 벽, 지나갈 수 있는 공간, 지훈이의 초기위치, 불이난공간을 의미한다. 불이 상하좌우로 번지므로 불의 전파 경로를 먼저 BFS로 구한다. 불이 번질 때마다 번진시간을 저장한다. 그 다음 지훈이가 이동할 수 있는 경로를 BFS로 구하는데, 지훈이가 특정 한을...","categories": ["BOJ"],
        "tags": ["Algorithm","BOJ","BFS"],
        "url": "/boj/boj-4179/",
        "teaser": "/assets/images/bio-photo.jpg"
      },{
